...
gtp(5,3,3). gtp(6,3,2). gtp(7,3,1). gtp(8,2,1). gblnk(2,2).
tp(1,1,2). tp(2,1,3). tp(3,2,1). tp(4,2,3).
tp(5,3,3). tp(6,2,2). tp(7,3,2). tp(8,1,1). blnk(3,1).

go:- calcH(1,[],L), sumList(L,V),write('Manhattan Distance: '),write(V), nl,
	write('Manhattan Distance:'), write(L).
calcH(9,X,X):-!.
